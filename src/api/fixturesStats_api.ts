...
import { FixtureStatisticsApiResponse, TeamStatistics } from "@components/TeamView/Matches/Statistics/stats-types";


const isDevelop = import.meta.env.DEV;

export const getFixtureStats = async (fixtureId: number): Promise<TeamStatistics[]>  => {
    if (isDevelop) {
