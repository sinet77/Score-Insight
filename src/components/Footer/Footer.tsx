        ...
        <section className={styles["wrapper"]}>
          <div className={styles["linksSection"]}>
            ...
            <div className={styles["topLeagues"]}>
              <h3 className={styles["links-title"]}>Top Leagues</h3>
              <ul>
          ...
          <div className={styles["rights-container"]}>
            <img src={footballer} alt="Footballer Icon" className={styles["footballer-icon"]} />
            <p className={styles["rights"]}>© 2025 Score Insight – All rights reserved</p>
          </div>
        </section>
      </div>
    </footer>
